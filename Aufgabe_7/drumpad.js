...
function playBeat() {
    var beat = ["kick.mp3", "kick.mp3", "snare.mp3", "kick.mp3", "kick.mp3", "hihat.mp3"];
    var index = 0;
    var time = setInterval(startBeat, 300);
    function startBeat() {
...
document.querySelector("#pauseButton").addEventListener("mousedown", stopBeat);
function stopBeat() {
    clearInterval(time);
}
